  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl px-6">
          What Our <br /> Customer says
        </h2>

        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
          <blockquote className="rounded-lg bg-[#3f3f3f] p-6 shadow-sm sm:p-8">
            <p className="mb-4 text-white">
              Our restautant is open 24 hours and we are providing the best
              services for Our restaurant is open 24 hours and we are providing
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex justify-center gap-0.5 text-[#ff5001]">
                  <svg
        ...
        <div className="bg-[#ff5001] flex flex-row items-end mt-[10rem] rounded-lg shadow-lg p-8 relative w-[100%] h-[50vh]">
          <img
