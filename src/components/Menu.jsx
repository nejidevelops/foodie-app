...
function Menu() {
  return (
    <div className="h-auto sm:h-[100vh] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center gap-6 px-4 sm:px-10 lg:px-20">
      <h2 className="text-2xl sm:text-4xl">Choose what food you want</h2>
      <p className="text-center max-w-md">
        Our restaurant is open 24 hours, providing the best service for our
        honorable clients.
      </p>
      <div className="grid gap-6 sm:gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        <div className="max-w-sm rounded overflow-hidden shadow-lg bg-[#f6f6f6]">
          <img
